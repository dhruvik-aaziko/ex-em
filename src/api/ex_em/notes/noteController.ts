...
class NoteController implements Controller {
    ...
    private uploadExcelData = async (
        ...
        try {
            ...
            for (let i = 0; i < documents.length; i += batchSize) {
                ...
                const result = await MongoService.insertMany(MONGO_DB_EXEM, this.Note, { insert: batch });
    ...
    public createNote = async (
        ...
        try {
            ...
            const result = await MongoService.create(MONGO_DB_EXEM, this.Note, {
                // insert: {
    ...
    public getNote = async (
        ...
        try {
            ...
            const result = await MongoService.find(MONGO_DB_EXEM, this.Note, { query: { companyName: companyName } });
    ...
    public updateNote = async (
        ...
        try {
            ...
            const result = await MongoService.findOneAndUpdate(MONGO_DB_EXEM, this.Note, options);
    ...
    public deleteNote = async (
        ...
        try {
            ...
            const result = await MongoService.deleteOne(MONGO_DB_EXEM, this.Note, {query: { _id: id }});
